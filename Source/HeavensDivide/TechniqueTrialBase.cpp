...
ATechniqueTrialBase::ATechniqueTrialBase()
{
	...
	TrialArena = CreateDefaultSubobject<USceneComponent>(TEXT("TrialArena")); TrialArena->SetupAttachment(SceneRoot); TrialArena->SetRelativeLocation(TrialArenaOffset);
	TrialFloor = CreateDefaultSubobject<UStaticMeshComponent>(TEXT("TrialFloor")); TrialFloor->SetupAttachment(TrialArena); TrialFloor->SetRelativeScale3D(FVector(30,30,.5));
	TrialPlayerStart = CreateDefaultSubobject<USceneComponent>(TEXT("TrialPlayerStart")); TrialPlayerStart->SetupAttachment(TrialArena); TrialPlayerStart->SetRelativeLocation(TrialPlayerOffset);
