...
void ASurvivorPlayerController::NinjaBuildPreview(const FString& BuildName)
{
 ...
 if(Wheel)for(auto Id:{TEXT("GreatShuriken"),TEXT("SerratedEdge"),TEXT("GrindingHalt"),TEXT("WideOrbit"),TEXT("BreakingWheel"),TEXT("HeavyShuriken"),TEXT("LingeringShuriken")})Grant(Id);
