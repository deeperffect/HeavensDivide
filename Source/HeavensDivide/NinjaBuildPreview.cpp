...
void ASurvivorPlayerController::NinjaBuildPreview(const FString& BuildName)
{
 ...
 const TArray<FName> All={TEXT("ReturningFang"),TEXT("BarrageStance"),TEXT("GreatShuriken"),TEXT("CuttingReturn"),TEXT("Bloodhound"),TEXT("RelentlessFang"),TEXT("FinalPursuit"),TEXT("FocusedVolley"),TEXT("ForkingProjectiles"),TEXT("AlternatingFans"),TEXT("Crescendo"),TEXT("NeedleRain"),TEXT("SerratedEdge"),TEXT("GrindingHalt"),TEXT("WideOrbit"),TEXT("BreakingWheel"),TEXT("EmbeddedBlades"),TEXT("FragmentDamage"),TEXT("FragmentLoad"),TEXT("FragmentReach")};
 ...
 if(Fang)for(auto Id:{TEXT("ReturningFang"),TEXT("CuttingReturn"),TEXT("Bloodhound"),TEXT("RelentlessFang"),TEXT("FinalPursuit")})Grant(Id);
 if(Barrage)for(auto Id:{TEXT("BarrageStance"),TEXT("FocusedVolley"),TEXT("ForkingProjectiles"),TEXT("AlternatingFans"),TEXT("Crescendo"),TEXT("NeedleRain")})Grant(Id);
