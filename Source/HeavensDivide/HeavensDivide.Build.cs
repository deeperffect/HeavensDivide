...
public class HeavensDivide : ModuleRules
{
	public HeavensDivide(ReadOnlyTargetRules Target) : base(Target)
	{
		...
		PrivateDependencyModuleNames.AddRange(new string[] { "Slate", "SlateCore", "EngineCameras", "AIModule" });
		if (Target.bBuildEditor)
		{
			PrivateDependencyModuleNames.AddRange(new string[] { "UnrealEd", "NiagaraEditor", "MaterialEditor" });
		}
	}
}
